...
var scoresound; var scoresound2;
...
function preload() {
    ...
    game.load.audio("scoresound2", "../assets/key.wav");
...
function create() {
    ...
    scoresound2 = game.add.audio('scoresound2');
}
...
function changeScore() {
    ...
    if (score > 9)
        game.stage.setBackgroundColor("#00BCD4");
    if (score > 4)
        game.add.text(660, 20, "Run!!", { font: "30px Arial", fill: "#f72727" });
    if (score > 7)
        scoresound2.play();
    else
        scoresound.play();
